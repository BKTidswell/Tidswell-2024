...
```{r}
school_data <- read.csv("Data/Fish_School_Values_Same_3D.csv")
...
ggsave("Final Graphs/School_NND_Same_3D.png")
```

### Num fish Within 2 BL

```{r}
raw_school_data <- read.csv("Data/Fish_Raw_Comp_Values_Same_3D.csv")
...
ggsave("Final Graphs/Mean_Group_Size_Same_3D.png")
```
...
ggsave("Final Graphs/Polarization_Same_3D.png")
```
...
ggsave("Final Graphs/Num_Aligned_Fish_2BL_Same_3D.png")
...
indiv_data <- read.csv("Data/Fish_Individual_Values_Same_3D.csv")
...
ggsave("Final Graphs/School_Speed_Over_Indiv_Speed_Same_3D.png")
