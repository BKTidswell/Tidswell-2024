...
```{r}
detections <- read_csv("/Users/Ben/Desktop/Charuco_DLT/charuco_boards/2023_02_09/boards.csv") |> 
  select(-`...1`)
```

Fill in the directory that has the video files and the names of each video.
```{r}
videodir <- '/Users/Ben/Desktop/Charuco_DLT/charuco_boards/2023_02_09'
...
```{r}
write_csv(ptsforeasywand, "/Users/Ben/Desktop/Charuco_DLT/2023_02_XX_calibrationcharuco_xypts.csv")
```
